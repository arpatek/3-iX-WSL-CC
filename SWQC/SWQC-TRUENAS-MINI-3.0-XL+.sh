...
# TrueNAS Mini XL+ BIOS Firmware Check
...
# TrueNAS Mini XL+ BMC Firmware Check
...
ipmitool sensor list | grep -i 'FAN[A12]' | cut -d "|" -f1 -f5 -f6 -f7 | xargs >swqc-tmp/"$SERIAL"-FAN-Thresh.txt
FANTHRESH=$(cat swqc-tmp/"$SERIAL"-FAN-Thresh.txt)

FANSETTINGS="FAN1 | 200.000 | 300.000 | 500.000 FAN2 | 200.000 | 300.000 | 500.000 FANA | 200.000 | 300.000 | 500.000"
