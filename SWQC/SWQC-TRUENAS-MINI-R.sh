...
# Grabbing Motherboard Info (Redbook Pg. 15)
...
# TrueNAS Mini R BIOS Firmware Check
...
# TrueNAS Mini R BMC Firmware Check
...
# Checking for Add-On NIC (Redbook Pg. 15)
...
# Checking Fan Speed Is Correctly Set to 00 (Redbook Pg. 41)
...
# Getting Read/Write Cache Drive Info (Redbook Pg. 15 & 42)
...

{
    ...
    echo -e "$BMCCHECK\n"
    echo -e "FAN SPEED: $FANSET\n"
    echo -e "$FANSPEEDCHECK\n"
