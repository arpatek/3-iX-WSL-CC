...
PROMPT=$'%{\e[0;31m%}%B┌─$(virtualenv_prompt_info)%{\e[0;31m%}%B[%b%{\e[0m%}%{\e[1;32m%}%n%{\e[1;30m%}\e[1;33m%}%B@%b%{\e[0m%}%{\e[0;35m%}%B%m%b%{\e[0;31m%}%B][%b%{\e[0;34m%}%b%{\e[1;37m%}%~%{\e[0;31m%}%B]%b%{\e[0m%}$(mygit)$(hg_prompt_info)
%{\e[0;31m%}%B└─▪$%b'
